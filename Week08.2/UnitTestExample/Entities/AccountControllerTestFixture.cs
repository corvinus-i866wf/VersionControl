...
namespace UnitTestExample.Entities
{
    class AccountControllerTestFixture
    {
        ...
        [   Test,
            TestCase("Abcdefga",false),
            TestCase("ADGADGDA234",false),
            TestCase("adgadgfa23",false),
        ...
        {
            var accountContreoller = new AccountController();
            var actualResult = accountContreoller.ValidatePassword(password);
            Assert.AreEqual(expectedResult, actualResult);
        }
        [
            Test,
